        ...
        >
          ...
          {state.success && !state.errors?.general && (
            <motion.div 
              ...
              transition={{ duration: 0.3 }}
            >
              <p>サインアップに成功しました。メールを確認してください。</p>
            </motion.div>
          )}
          ...
          <form action={action} className="space-y-6">
            ...
            <motion.button
              type="submit"
              disabled={pending}
              className="w-full flex justify-center items-center bg-gradient-to-r from-green-500 to-emerald-600 text-white py-3 px-4 rounded-xl font-medium shadow-lg hover:shadow-xl transition duration-300 ease-in-out disabled:opacity-70"
          ...
          >
            <Link href="/login" className="text-blue-300 hover:text-white flex items-center justify-center">
